...
### Contours default behavior (design decision)
Pick one:
...
### Loading strategy (design decision)  ★ new
Pick one:
...
### Fix mobile viewport / search bar layout
...
### Touch navigation — drag + pinch-zoom tuning
...
### First glimpse — opening experience
...
### Contours: zoom-based behavior + lighter appearance
...
### Verify modulepreload  ★ revised — likely already done
...
### Lazy-load deferred data  ★ expanded
...
### Quantized-mesh terrain tiles  ★ revised — higher effort, architecturally required for viewport strategy
...
### Initial-view bundle + aggressive CDN caching  ★ new
...
### Shareable URLs  ★ highest virality leverage
...
### Fix label layering (hemisphere cull)
...
### User testing round 1 (post mobile UX)
...
### User testing round 2 (pre-launch)
...
### Clean code / data format unification
Do during lulls. Don't block launch.

### Accurate Mars ellipsoid
