...
export const ROVER_META: Record<string, { description: string; imageUrl: string }> = {
  perseverance: {
    imageUrl: 'https://assets.science.nasa.gov/dynamicimage/assets/science/psd/mars/news_items/main_images/9130_PIA24836-web.jpg',
    description:
  ...
  curiosity: {
    imageUrl: 'https://science.nasa.gov/wp-content/uploads/2024/02/6352-curiosity-rover-selfie-windjana-holes-pia18390-full2.jpg',
    description:
  ...
  spirit: {
    imageUrl: 'https://assets.science.nasa.gov/dynamicimage/assets/science/psd/solar/2023/07/rover2-1.jpg?w=1280&h=960&fit=clip&crop=faces%2Cfocalpoint',
    description:
  ...
  sojourner: {
    imageUrl: 'https://assets.science.nasa.gov/dynamicimage/assets/science/psd/solar/2023/09/p/i/a/0/PIA01551-1.jpg?w=1099&h=572&fit=clip&crop=faces%2Cfocalpoint',
    description:
